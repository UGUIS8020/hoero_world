...
from models import BlogCategory, BlogPost, Inquiry
from main.forms import BlogCategoryForm, UpdateCategoryForm, BlogPostForm, BlogSearchForm, InquiryForm
from app import db
from main.image_handler import add_featured_image
